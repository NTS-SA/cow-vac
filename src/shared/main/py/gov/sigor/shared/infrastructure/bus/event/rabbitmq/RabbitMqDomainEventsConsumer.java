package py.gov.sigor.shared.infrastructure.bus.event.rabbitmq;
...
import py.gov.sigor.shared.domain.Utils;
import py.gov.sigor.shared.domain.bus.event.DomainEvent;
import py.gov.sigor.shared.infrastructure.bus.event.DomainEventJsonDeserializer;
import py.gov.sigor.shared.infrastructure.bus.event.DomainEventSubscribersInformation;
