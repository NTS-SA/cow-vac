...
public final class ApiExceptionMiddleware implements Filter {
    ...
    public void doFilter(
        ...
        try {
            ...
            if (Objects.nonNull(mapping.getHandler(httpRequest))) {
                possibleController = (
                    (HandlerMethod) mapping.getHandler(httpRequest).getHandler()
                ).getBean();
            }
            ...
            try {
                ...
                if (Objects.isNull(possibleController) || !(possibleController instanceof ApiController)) {
                    throw exception;
                }
